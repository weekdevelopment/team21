...
<div class="container">
    <div class="wrap">
        ...
        <div class="contents" id="contents">
            <div class="breadcrumb">
                <p><a href="<%=path8 %>">HOME</a> &gt; <a href="<%=path8 %>/qna/qnaList.jsp">질문 및 답변</a> &gt; <span>질문 및 답변 글 상세보기</span></p>
            </div>
            <section class="page" id="page1">
                <div class="page_wrap">
                    ...
                    <table class="tb1" id="myTable">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <% if(qna.getLev()==0) { %>
                                <% if(sid!=null) { %>
                                <a href="<%=path8 %>/qna/addQuestion.jsp?lev=1&par=<%=qna.getQno() %>" class="inbtn">답변하기</a>
                                <% } %>
                                <% if(sid!=null && (sid.equals("admin") || sid.equals(qna.getAuthor()))) { %>
                                <a href="<%=path8 %>/qna/updateQna.jsp?qno=<%=qna.getQno() %>" class="inbtn">질문 수정하기</a>
                                <a href="<%=path %>/qna/delQna.jsp?qno=<%=qna.getQno() %>&lev=0" class="inbtn">질문 삭제하기</a>
                                <% } %>
                                <% } else { %>
                                <% if(sid!=null && (sid.equals("admin") || sid.equals(qna.getAuthor()))) { %>
                                <a href="<%=path8 %>/qna/updateQna.jsp?qno=<%=qna.getQno() %>" class="inbtn">답변 수정하기</a>
                                <a href="<%=path8 %>/qna/delQna.jsp?qno=<%=qna.getQno() %>&lev=1" class="inbtn">답변 삭제하기</a>
                                <% } %>
                                <% } %>
                                <a href="<%=path8 %>/qna/qnaList.jsp" class="inbtn">목록</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    %>
                    <form action="<%=path8 %>/comment/addCommentPro.jsp" method="post" class="comment-form">
    ...
    <script>
        function delComment(qno, cno) {
            ...
            if (flag) {
                location.href = "<%=path8 %>/comment/delCommentPro.jsp?qno=" + qno + "&cno=" + cno;
            }
        }

        function redirectToLogin() {
            location.href = "<%=path8 %>/member/login.jsp";
        }
    </script>
</body>
</html>