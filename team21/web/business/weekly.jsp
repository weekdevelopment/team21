...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="<%=path8 %>">HOME</a> &gt <span>사업영역</span> &gt <span>위클리</span> </p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">위클리</h2>
                <hr>
                <div class="row">
                    ...
                    <section>
                        <div class="img1">
                            <p class="img1_tit">Weekly는 평일을 의미하는 week-day에서 따온 이름입니다. <br> 아이들이 학습을 돕는 회사로서 준비중입니다.</p>
                        </div>
                    </section>
                </div>
            </div>
