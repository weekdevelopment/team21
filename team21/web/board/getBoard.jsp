...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="<%=path8 %>">HOME</a>  &gt <span>공지사항</span></p>
        </div>
                ...
                <div class="btn_group">
                    ...
                    <tr>
                        <td>
                            ...
                            %>
                            <a href="<%=path8 %>/board/updateBoard.jsp?bno=<%=bd.getBno() %>" class="inbtn">글 수정</a>
                            <a href="<%=path8 %>/board/delBoard.jsp?bno=<%=bd.getBno() %>" class="inbtn">글 삭제</a>
                            <%
                            }
                            %>
                            <a href="<%=path8 %>/board/boardList.jsp" class="inbtn">공지사항 목록</a>
                        </td>
                    </tr>
                </div>
            </div>
