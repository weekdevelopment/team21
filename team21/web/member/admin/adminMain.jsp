    ...
    <div class="wrap">
        ...
        <div class="contents" id="contents">
            <div class="breadcrumb">
                <p><a href="<%=path8 %>">HOME</a> &gt; <span>관리자 페이지</span></p>
            </div>
            <section>
                ...
                <div class="inner">
                    <div class="wrap">
                        <a class="wrap-a" href="<%=path8 %>/member/admin/admin.jsp">
                            📂 회원정보 관리
                        </a>
                        <a class="wrap-a" href="<%=path8 %>/member/admin/adminBoard.jsp">
                            📝 공지사항 관리
                        </a>
                        <a class="wrap-a" href="<%=path8 %>/member/admin/adminMasscom.jsp">
                            📰 언론보도 관리
                        </a>
                        <a class="wrap-a" href="<%=path8 %>/member/admin/adminWeekcrew.jsp">
                            📩 윜크루 지원 관리
                        </a>
                    </div>
                </div>
