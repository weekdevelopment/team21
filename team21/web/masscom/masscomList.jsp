...
<%
    ...
    conn = con.connect();
    String sql = "select * from masscom order by mno";
...
<head>
    ...
    <style>
        ...
        .tb1 .item1_tit { width:80%; text-align: center; }
        .tb1 .item1 { width:80%; text-indent: 150px; text-align: left; }
        .tb1 .item2 { width:20%; }
    ...
    <div class="wrap">
        ...
        <div class="contents" id="contents">
            <div class="breadcrumb">
                <p><a href="<%=path8 %>">HOME</a> &gt; <a href="">윜 News</a> &gt; <span>언론보도</span></p>
            </div>
                    ...
                    <div class="btn_group">
                        ...
                        <tr>
                            <td>
                                ...
                                <a href = "/masscom/addMasscom.jsp" class="inbtn">언론보도 등록</a>
                                <% } %>
                            </td>
                        </tr>
                    </div>
